        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead>
                <tr class="bg-gray-50">
                    ...
                    <th class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Bulan</th>
                    <th class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Nama Perusahaan</th>
                    <th class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Nama Owner</th>
                    <th class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Chapter / Area</th>
                    <th class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Investasi Modal</th>
                    <th class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Total Penjualan</th>
                    <th class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Total Keuntungan</th>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-3 py-4 whitespace-nowrap text-center">
                        <div class="flex justify-center space-x-1">
                            <button class="bg-green-500 hover:bg-green-600 text-white px-2 py-1 rounded-md shadow-sm text-xs flex items-center transition duration-300" 
                                   onclick="openViewModal({{ $i }})">
                                <i data-lucide="eye" class="w-3 h-3 mr-1"></i> View
                            </button>
                            <button class="bg-red-500 hover:bg-red-600 text-white px-2 py-1 rounded-md shadow-sm text-xs flex items-center transition duration-300"
            ...
            <div class="bg-white rounded-md shadow p-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="bg-green-50 p-3 rounded-md">
                        ...
                        <p class="text-lg font-semibold text-green-600" id="view-sales">Rp 0</p>
                    </div>
